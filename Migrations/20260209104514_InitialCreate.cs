    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnimalKeepers", x => new { x.AnimalId, x.KeeperId });
                    table.ForeignKey(
                        name: "FK_AnimalKeepers_Animals_AnimalId",
                        column: x => x.AnimalId,
                        principalTable: "Animals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnimalKeepers_Keepers_KeeperId",
                        column: x => x.KeeperId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnimalKeepers_KeeperId",
                table: "AnimalKeepers",
                column: "KeeperId");
